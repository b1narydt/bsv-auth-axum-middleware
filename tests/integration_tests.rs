...
async fn test_01_simple_post_with_json() {
    ...
    let url = format!("{base_url}/other-endpoint");
    println!("[test_01] POST {url} with JSON body");
...
async fn test_01b_error_500() {
    ...
    let url = format!("{base_url}/error-500");
    println!("[test_01b] POST {url} expecting 500");
...
async fn test_02_post_url_encoded() {
    ...
    let url = format!("{base_url}/other-endpoint");
    println!("[test_02] POST {url} with URL-encoded body");
...
async fn test_03_post_plain_text() {
    ...
    let url = format!("{base_url}/other-endpoint");
    println!("[test_03] POST {url} with plain text body");
...
async fn test_04_post_binary() {
    ...
    let url = format!("{base_url}/other-endpoint");
    println!("[test_04] POST {url} with binary body");
...
async fn test_07_put_with_json() {
    ...
    let url = format!("{base_url}/put-endpoint");
    println!("[test_07] PUT {url} with JSON body");
...
async fn test_08_delete() {
    ...
    let url = format!("{base_url}/delete-endpoint");
...
async fn test_09_large_binary_upload() {
    ...
    let url = format!("{base_url}/large-upload");
    println!(
...
async fn test_10_query_parameters() {
    ...
    let url = format!("{base_url}/query-endpoint?param1=value1&param2=value2");
...
async fn test_11_custom_headers() {
    ...
    let url = format!("{base_url}/custom-headers");
    println!("[test_11] GET {url} with custom header");
...
async fn test_13_charset_injection() {
    ...
    let url = format!("{base_url}/other-endpoint");
    println!("[test_13] POST {url} with charset in content-type");
...
async fn edge_case_a_no_content_type() {
    ...
    let url = format!("{base_url}/other-endpoint");
    println!("[edge_a] POST {url} with NO content-type header");
...
async fn edge_case_b_json_content_undefined_body() {
    ...
    let url = format!("{base_url}/other-endpoint");
    println!("[edge_b] POST {url} with JSON content-type but NO body");
...
async fn edge_case_c_json_content_object_body() {
    ...
    let url = format!("{base_url}/other-endpoint");
    println!("[edge_c] POST {url} with JSON content-type and empty object body");
...
async fn test_12_server_restart() {
...

    {
        ...
        let url = format!("{server1_url}/custom-headers");
        println!("[test_12] Phase 1: GET {url} on first server");
...

    {
        ...
        let auth_fetch2 = AuthFetch::new(client_wallet2);
        ...
        let url = format!("{server2_url}/custom-headers");
        println!("[test_12] Phase 2: GET {url} on new server");
...
async fn test_14_stale_session_recovery() {
    ...
    let server2_url = create_test_server().await;
    println!(
        "[test_14] Step 2: Server restarted (sessions cleared): {server1_url} -> {server2_url}"
    );
...
async fn test_15_multiple_requests_survive_session_reset() {
    ...
    // --- Step 1: POST "before reset" ---
    {
        ...
        let url = format!("{server1_url}/other-endpoint");
    ...
    // --- Step 3: POST "after reset" with same identity key ---
    {
        ...
        let url = format!("{server2_url}/other-endpoint");
...
async fn test_concurrent_authenticated_requests() {
    ...
    for i in 0..5 {
        let url = format!("{server_url}/other-endpoint");
        let task_id = i;
        ...
        let handle = tokio::spawn(async move {
            ...
            println!("[test_concurrent] Task {task_id} starting POST to {url}");

            let response = auth_fetch
                .fetch(&url, "POST", Some(body), Some(headers))
                .await
                .unwrap_or_else(|e| panic!("task {task_id} auth fetch should succeed: {e:?}"));
            ...
            assert_eq!(response.status, 200, "task {task_id} expected status 200");
